...
namespace UnityEngine.InputSystem.PS4.LowLevel
{
    ...
    internal struct MoveControllerPS4OuputCommand : IInputDeviceCommandInfo
    {
        ...
        internal const int kSize = InputDeviceCommand.BaseCommandSize + 5;
        ...
        [FieldOffset(InputDeviceCommand.BaseCommandSize + 1)] public byte motorSpeed;
        [FieldOffset(InputDeviceCommand.BaseCommandSize + 2)] public byte redColor;
        [FieldOffset(InputDeviceCommand.BaseCommandSize + 3)] public byte greenColor;
        [FieldOffset(InputDeviceCommand.BaseCommandSize + 4)] public byte blueColor;
...
namespace UnityEngine.InputSystem.PS4
{
    ...
    [InputControlLayout(commonUsages = new[] { "Primary", "Secondary", "LeftHand", "RightHand"}, stateType = typeof(MoveControllerStatePS4))]
    [Scripting.Preserve]
    public class MoveControllerPS4 : InputDevice, IHaptics
    {
        ...
        public static InternedString PrimaryUsageName = new InternedString("Primary");
        public static InternedString SecondaryUsageName = new InternedString("Secondary");
        // LeftHand and RightHand are already available in InputSystem.CommonUsages.LeftHand, RightHand.
        ...
        private void SetPrimarySecondaryUsage()
        {
            bool primary = moveIndex == 0;
            InternedString usage = primary ? PrimaryUsageName : SecondaryUsageName;
            // Allow for the possibility of this device having previously been the other.
            // I don't think this can ever happen but it does no harm to be sure.
            InternedString other = usage == PrimaryUsageName ? SecondaryUsageName : PrimaryUsageName;
            InputSystem.RemoveDeviceUsage(this, other);
            InputSystem.AddDeviceUsage(this, usage);
        }
